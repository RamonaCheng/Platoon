...
for episode in range(1):
    ...
    Qmatrix_2 = agent_2.return_time_matrix()
    Qmatrix_table = [Qmatrix_1, Qmatrix_2]
            ...
            for j in range(len(arrival_junction)):
                ...
                if junction_id == 2:
                    ...
                    if state2 is not None:
                        agent_2.take_action(state2, Qmatrix_table)
                ...
                # the end point cost calculation
                    ...
                    if state3 is not None:
                        ...
                        if previous_node == 2:
                            ...
                            Qmatrix_table[1] = agent_2.return_time_matrix()
        '''
