...
@Description: 
@LastEditTime: 2023-03-31 21:34:13
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    ...
    def get_state(self, junction_vehicle, junction_time):
        if self.vehicle_count == 0:
            ...
            if temp_des == 2:
                ...
                self.lead_path = traci.simulation.findRoute('link12', 'link15', 'connected').edges
            elif temp_des == 3:
                # select the shorest path
                ...
                self.lead_path = traci.simulation.findRoute('link13', 'link19', 'connected').edges
    ...
    def take_action(self, state, junction_vehicle):
        ...
        if temp_path[0] == 'link12':
            self.action = 12
        elif temp_path[0] == 'link13':
            self.action = 13
