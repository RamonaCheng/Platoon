...
@LastEditTime: 2023-04-18 17:42:48
'''
import numpy as np
...
def generate_routefile():
	...
	arrival_rate_list = [0.20]

	routes=open("./Nguyen-Dupuis/N2_500_020.rou.xml", "w")
...
<routes>
    ...
    <vType id="connected_pLeader" vClass="passenger" length="5" carFollowModel="IDM" maxSpeed="40.00" lcCooperative="0.0" color="1,1,0" lcStrategic="1.0" accel="13.0" decel="1.5" emergencyDecel="4.5" lcSpeedGain="0.3" sigma="0.0" lcKeepRight="0.3"/>
