...
@Description: 
@LastEditTime: 2023-04-15 20:10:06
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        # self.Qmatrix = [[833.0, 1208.0], [958.0, 1167.0]]      # end2_link7, end2_link8, end3_link7, end3_link8
        self.Qmatrix = [[292.0, 292.0], [292.0, 292.0]]      # end2_link7, end2_link8, end3_link7, end3_link8
    ...
    def reset(self, learning_rate):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        # self.Qmatrix = [[833.0, 1208.0], [958.0, 1167.0]]
        self.Qmatrix = [[292.0, 292.0], [292.0, 292.0]]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
