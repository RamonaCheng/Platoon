...
class JuctionAgent:
    ...
    def get_state(self, junction_vehicle, junction_time):
        if self.vehicle_count == 0:
            ...
            if temp_des == 2:
                self.lead_path = traci.simulation.findRoute('link14', 'link15', 'connected').edges
            elif temp_des == 3:
                self.lead_path = traci.simulation.findRoute('link14', 'link16', 'connected').edges
    ...
    def take_action(self, state, junction_vehicle):
        ...
        # calculate the temp vehicle path
