...
@Description: 
@LastEditTime: 2023-03-31 21:32:19
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self.initial_value = [1.0, 12.0, -12.0]
    ...
    def get_state(self, junction_vehicle, junction_time):
        if self.vehicle_count == 0:
            ...
            if temp_des == 2:
                ...
                self.lead_path = traci.simulation.findRoute('link18', 'link11', 'connected').edges
            elif temp_des == 3:
                # select the shorest path
                ...
                self.lead_path = traci.simulation.findRoute('link17', 'link16', 'connected').edges
    ...
    def take_action(self, state, junction_vehicle):
        ...
        if temp_path[0] == 'link17':
            self.action = 17
        elif temp_path[0] == 'link18':
            self.action = 18
