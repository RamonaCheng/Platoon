...
for CAV_ratio in CAV_ratio_list:
	
	print('Number of vehicles: ', CAV_ratio * num_veh)
...
plt.plot(CAV_ratio_list, total_cost_basic, label='Basic')
plt.plot(CAV_ratio_list, total_cost_cdc, label='CDC')
plt.plot(CAV_ratio_list, total_cost_dp, label='DP')

plt.xlabel('Vehicle Number', fontsize=25)
