...
plt.plot(gamma_list, total_cost_basic, label='Basic')
plt.plot(gamma_list, total_cost_cdc, label='CDC')
plt.plot(gamma_list, total_cost_dp, label='DP')

plt.xlabel('Discount Factor', fontsize=25)
