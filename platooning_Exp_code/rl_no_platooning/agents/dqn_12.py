...
@Description: 
@LastEditTime: 2023-04-15 20:15:44
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        # self.Qmatrix = [[1125.0, 1000.0], [1250.0, 1250.0]]      # end2_link17, end2_link18, end3_link17, end3_link17
        self.Qmatrix = [[375.0, 208.0], [375.0, 375.0]]           # end2_link17, end2_link18, end3_link17, end3_link17
    ...
    def reset(self, learning_rate):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        # self.Qmatrix = [[1125.0, 1000.0], [1250.0, 1250.0]]
        self.Qmatrix = [[375.0, 208.0], [375.0, 375.0]]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
