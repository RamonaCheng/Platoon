...
@Description: 
@LastEditTime: 2023-04-15 20:15:24
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        # self.Qmatrix = [[1083.0, 1083.0], [1042.0, 875.0]]      # end2_link12, end2_link12, end3_link12, end3_link13
        self.Qmatrix = [[292.0, 292.0], [292.0, 208.0]]      # end2_link12, end2_link12, end3_link12, end3_link13
    ...
    def reset(self, learning_rate):
        ...
        self.memory = deque(maxlen=MAX_MEMORY)
        # self.Qmatrix = [[1083.0, 1083.0], [1042.0, 875.0]]      # end2_link12, end2_link12, end3_link12, end3_link13
        self.Qmatrix = [[292.0, 292.0], [292.0, 208.0]]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
