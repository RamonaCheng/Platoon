...
@Description: 
@LastEditTime: 2023-04-15 20:15:30
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        # self.Qmatrix = [667.0, 625.0]      # end2_link14, end3_link14
        self.Qmatrix = [208.0, 208.0]      # end2_link14, end3_link14
    ...
    def reset(self, learning_rate):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        # self.Qmatrix = [667.0, 625.0]
        self.Qmatrix = [208.0, 208.0]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
