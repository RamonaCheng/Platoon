...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self.Qmatrix = [[354.1666666666667, 354.1666666666667], [354.1666666666667, 304.1666666666667]]       # end2_link5, end2_link6, end3_link5, end3_link6
        ...
        self.dqn_file = open('./dqn5.csv', 'w', encoding='utf-8')
        self._switch = 1
    ...
    def reset(self, learning_rate, _lambda):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        self.Qmatrix = [[354.1666666666667, 354.1666666666667], [354.1666666666667, 304.1666666666667]]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
    ...
    def take_action(self, state, Qmatrix_table):
        ...
        if d2_distance == 0 or sk > int(d1/24)-2:
            ...
            #print('parameters: ', self.arrival_rate, self.initial_value, w_1/3600.0, gamma, d2_distance, 24.0, w_2)
    ...
    def return_time_matrix(self):
        ...
        #     self.Qmatrix[0][0] = 9999
        #     self.Qmatrix[1][0] = 9999
        # elif (traci.simulation.getTime() > 2000) and self._switch == 1:
        #     self.Qmatrix[0][0] = 354.1666666666667
        #     self.Qmatrix[1][0] = 354.1666666666667
