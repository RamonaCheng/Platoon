...
@Description: 
@LastEditTime: 2023-04-14 22:33:34
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self.Qmatrix = [104.16666666666667, 104.16666666666667]           # end2, end3
        ...
        self._lambda = 1
        self.dqn_file = open('./dqn11.csv', 'w', encoding='utf-8')
    ...
    def reset(self, learning_rate, _lambda):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        self.Qmatrix = [104.16666666666667, 104.16666666666667]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
    ...
    def get_state(self, junction_vehicle, junction_time):
        if self.vehicle_count == 0:
            ...
            self.lead_path = dis.return_path(11, temp_des, dis.return_initial_Qmatrix_Table())
    ...
    def update_onestep(self):
        ...
        #min_q = min(self.model.predict(self.norm_state)[0])\
