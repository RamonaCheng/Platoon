...
@Description: 
@LastEditTime: 2023-04-14 22:32:11
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self.Qmatrix = [[187.5, 187.5], [187.5, 187.5]]      # end2_link9, end2_link10, end3_link10, end3_link10
        ...
        self._lambda = 1
        self.dqn_file = open('./dqn7.csv', 'w', encoding='utf-8')
    ...
    def reset(self, learning_rate, _lambda=1):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        self.Qmatrix = [[187.5, 187.5], [187.5, 187.5]]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
