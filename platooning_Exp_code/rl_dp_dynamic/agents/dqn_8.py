...
@Description: 
@LastEditTime: 2023-04-14 22:32:44
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self._lambda = 1
        self.dqn_file = open('./dqn8.csv', 'w', encoding='utf-8')
    ...
    def take_action(self, state, Qmatrix_table):
        ...
        #d2_distance = Qmatrix_table[5][0] * 24.0 - d1
        d2_distance, original_equiva_distance = dis.d2_distance(current_node, 2, 2, 11, self.action, Qmatrix_table, [2], [2])

        if d2_distance == 0 or sk > int(d1/24)-2:
            self.action_platoon = 0
            # decide the deceleration process
            final_value = threshold_func.theta_c(self.arrival_rate, [0.3, 8.0, -8.0], w_1/3600.0, gamma, original_equiva_distance, 24.0, w_2)
    ...
    def experience_replay(self):
        if len(self.memory) < BATCH_SIZE:
            ...
            for state, action, min_q, cost in minibatch:
                ...
                #print('Junction 8 Q Value: ', self.Qmatrix[0])
