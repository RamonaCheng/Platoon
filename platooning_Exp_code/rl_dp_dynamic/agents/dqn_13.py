...
@Description: 
@LastEditTime: 2023-04-19 17:52:03
'''
import gym
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self.Qmatrix = [104.16666666666667]      # end2_link11
        ...
        self.InLinks = ['link13']
        self.OutLinks = ['link19']
        self.InNodes = [9]
        self.OutNodes = [3]
        #self.OutLength = [11.0]         # kilometers
        ...
        self.action = 19                                # 19 represents link19
        ...
        self._lambda = 1
        self.dqn_file = open('./dqn13.csv', 'w', encoding='utf-8')
    ...
    def reset(self, learning_rate, _lambda):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        self.Qmatrix = [104.16666666666667]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
    ...
    def get_state(self, junction_vehicle, junction_time):
        if self.vehicle_count == 0:
            ...
            if self.temp_vehicle in self.vehicle_container:
                ...
                #print('junction 13 state: ', self.state)
    ...
    def take_action(self, state, Qmatrix_table):
        ...
        #d2_distance = Qmatrix_table[10][0] * 24.0 - d1
        d2_distance, original_equiva_distance = dis.d2_distance(current_node, 3, 3, 19, self.action, Qmatrix_table, [3], [3])

        if d2_distance == 0 or sk > int(d1/24)-2:
            self.action_platoon = 0 # non merging
        ...
        #print('junction 13 action: ', self.action)
    ...
    def experience_replay(self):
        if len(self.memory) < BATCH_SIZE:
            ...
            for state, action, min_q, cost in minibatch:
                ...
                #print('junction 13 self.Qmatrix[0]: ', self.Qmatrix[0])
