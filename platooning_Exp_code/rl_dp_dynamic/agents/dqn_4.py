...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self.Qmatrix = [[270.8333333333333, 270.8333333333333], [270.8333333333333, 270.8333333333333]]      # end2_link3, end2_link4, end3_link3, end3_link4
        ...
        self._lambda = 1
        self.dqn_file = open('./dqn4.csv', 'w', encoding='utf-8')
        self._switch = 1
    ...
    def reset(self, learning_rate, _lambda):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        self.Qmatrix = [[437.5, 387.5], [387.5, 337.5]]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
    ...
    def return_time_matrix(self):
        ...
        #     self.Qmatrix[1][1] = 9999
        # elif (traci.simulation.getTime() > 2000) and self._switch == 1:
        #     self.Qmatrix[0][1] = 387.5
        #     self.Qmatrix[1][1] = 337.5 
