...
@LastEditTime: 2023-04-18 19:40:45
'''
import random
import numpy as np
...
class JuctionAgent:
    def __init__(self, observation_space, action_space):
        ...
        self.Qmatrix = [[437.5, 375.0], [387.5, 437.5]]           # [s / tarvel time] end2_link1, end2_link2, end3_link1, end3_link2
        ...
        self.initial_value = [2.0, 10.0, -10.0]         # initial value for the threshold and C value
        ...
        self.dqn_file = open('./dqn1.csv', 'w', encoding='utf-8')
    ...
    def reset(self, learning_rate, _lambda=1):
        self.temp_memory = deque(maxlen=MAX_MEMORY)
        self.memory = deque(maxlen=MAX_MEMORY)
        self.Qmatrix = [[437.5, 375.0], [387.5, 437.5]]
        self.lead_vehicle = None
        self.temp_vehicle = None
        self.lead_time = 0.0
        self.temp_time = 0.0
    ...
    def take_action(self, state, Qmatrix_table):
        ...
        if d2_distance == 0 or sk > int(d1/24)-2: #  TODO
            self.action_platoon = 0
    ...
    def add_to_memory(self, current_vehicle_id, min_q, departure_link_fuel, departure_link_time):
        ...
        for item in list(self.temp_memory):
            if current_vehicle_id == item[0]:
                ...
                exp_vehicle_time = self.edge_length/last_time_speed # 目前期望的驾驶时间
